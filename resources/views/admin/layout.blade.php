  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      <div class="list-group list-group-flush">
        <a href="{!! route('admin.posts') !!}" class="list-group-item list-group-item-action bg-light">Posts</a>
        ...
        <a href="{!! route('admin.user.role') !!}" class="list-group-item list-group-item-action bg-light">Roles</a>        
      </div>
    </div><!-- /#sidebar-wrapper -->
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            <li class="nav-item">
              <a class="nav-link" href="{!! route('admin.home') !!}"><i class="fas fa-home"></i> <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
